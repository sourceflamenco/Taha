...
@app.on_message(
    filters.command("شرح التشغيل بمنصات الاغاني"))
...
@app.on_message(
    filters.command("اوامر المجموعة"))
