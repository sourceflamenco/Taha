...
@app.on_message(filters.regex("^تعطيل خيروك$") & filters.group)
...
@app.on_message(filters.regex("^تفعيل خيروك$") & filters.group)
...
@app.on_message(filters.regex("^لو$") & filters.group)
